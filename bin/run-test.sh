...
docker exec magento-php magento2/vendor/phpunit/phpunit/phpunit --configuration magento2/app/code/MercadoPago/PaymentMagento/phpunit.xml --coverage-clover clover.xml --coverage-text --coverage-html reports/ magento2/app/code/MercadoPago/PaymentMagento/Tests

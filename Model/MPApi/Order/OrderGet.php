...
/**
 * API client to fetch Order details.
 * Endpoint: GET /plugins-platforms/v1/orders/{orderId}
 */
class OrderGet
{
    /**
    ...
    /**
     * Send metric for successful order get.
     *
     * @return void
     */
    ...
    /**
     * Send metric for order get error.
     *
